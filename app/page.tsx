    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 px-4">
          <h1
            style={{ fontFamily: "Dear, cursive", fontSize: "clamp(4rem, 12vw, 10rem)", lineHeight: 1.1 }}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            {["Mariages", "Soirées privées", "Anniversaires", "Bals"].map((s) => (
              <span
                key={s}
                className="inline-block border border-[#3b2fb5] text-white/80 px-4 py-2 rounded-full text-sm hover:bg-[#3b2fb5]/20 transition w-fit"
              >
                {s}
              </span>
            ))}
